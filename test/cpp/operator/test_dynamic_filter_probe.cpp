 ...
 *        carrier-typed build sets, cross-carrier mask identity, and fixed-point keys (DECIMAL32/
 *        64/128 at one scale, checked against the zone map that already lowers those types).
 */
