 ...
 *        set — the filtered decode must not require a materialized cast. A dictionary-encoded
 *        STRING key chunk is reconstructed to STRING before the probe, which fingerprints it
 *        in-kernel against a STRING-built set.
 */
